...
export const SYSTEM_CATALOG=Object.freeze([
 {id:'aero',spread:[0,-.9,0],number:'01',label:'Aerodinâmica',short:'AERO',chapter:'0:14',color:'#52c8df',howItWorks:'As asas, o assoalho e o difusor desviam o ar para criar uma diferença de pressão que empurra o carro contra a pista. Essa carga dá aderência nas curvas, mas cobra arrasto nas retas; em 2026 a aerodinâmica ativa move os flaps das duas asas entre o modo de curva e o modo de reta.',observe:'Siga as fitas de ar do bico ao difusor e veja como os túneis do assoalho se estreitam. Abra a vista explodida para separar asa de viga, defletores e o atuador do flap traseiro.',description:'Tudo o que a carroceria esconde e que produz carga aerodinâmica: túneis do assoalho, cercas de borda, palhetas do difusor, asa de viga, atuador hidráulico do flap traseiro, defletores e ajustadores da asa dianteira. As fitas mostram o caminho do ar.'},
