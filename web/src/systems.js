...
export const SYSTEM_CATALOG=Object.freeze([
 {id:'aero',spread:[0,-.9,0],number:'01',label:'Aerodinâmica',short:'AERO',chapter:'0:14',color:'#52c8df',description:'Tudo o que a carroceria esconde e que produz carga aerodinâmica: túneis do assoalho, cercas de borda, palhetas do difusor, asa de viga, atuador hidráulico do flap traseiro, defletores e ajustadores da asa dianteira. As fitas mostram o caminho do ar.'},
 {id:'structure',spread:[0,1.0,0],number:'02',label:'Estrutura central / survival cell didática',short:'ESTRUTURA',chapter:'4:47',color:'#c5a7ff',description:'A célula de sobrevivência: sanduíche de carbono e colmeia com janela de corte no núcleo, anteparas, prisioneiros do motor, insertos de titânio das ancoragens da suspensão e prancha com patins. Motor e câmbio se aparafusam atrás dela e completam a estrutura.'},
 ...
 {id:'steering',spread:[0,.7,1.7],number:'04',label:'Direção',short:'DIREÇÃO',chapter:'7:52',color:'#ff8c6b',description:'Coluna de carbono com duas juntas universais, pinhão e cremalheira na antepara dianteira, barras de direção em perfil de asa até os uprights, servo hidráulico e linhas de assistência.'},
 {id:'brakes',spread:[0,-.6,.9],number:'05',label:'Freios',short:'FREIOS',chapter:'8:57',color:'#ff665d',description:'Discos carbono-carbono ventilados, campanas, pinças monobloco de seis pistões, tambores e dutos de refrigeração, pedal usinado no pé esquerdo, dois cilindros mestres com barra de balanço, brake-by-wire traseiro e linhas rígidas e trançadas.'},
 {id:'power',spread:[0,1.3,-.4],number:'06',label:'Unidade de potência',short:'V6 TURBO',chapter:'11:32',color:'#ff9f58',description:'V6 de 1,6 litro a 90° com cárter seco, cabeçotes e tampas de comando, turbo dividido (compressor à frente, turbina atrás, eixo comum pelo vale do motor), dois plenums com seis trompetas, duto do airbox, dutos do intercooler, coletores em Inconel, wastegates e escapamento. Na versão 2021 o MGU-H fica acoplado ao eixo do turbo; em 2026 ele deixa de existir.'},
 {id:'ers',spread:[0,-.8,-.3],number:'07',label:'ERS híbrido',short:'ERS',chapter:'14:14',color:'#ffe36b',description:'O sistema híbrido: energy store sob o tanque, eletrônica de controle e inversor, MGU-K engrenado ao virabrequim e, na versão 2021, o MGU-H no turbo. Cabos laranja de alta tensão ligam tudo; as fitas mostram a recuperação na frenagem e a entrega na aceleração.'},
 {id:'cooling',spread:[0,-.4,-1.1],number:'08',label:'Refrigeração',short:'REFRIGERAÇÃO',chapter:'14:54',color:'#66e0b2',description:'Refrigeração assimétrica: intercooler ar-ar inclinado e arrefecedor do câmbio no sidepod esquerdo; radiador de água, arrefecedor de óleo e arrefecedor de baixa temperatura do ERS no direito, com tanques, mangueiras e abraçadeiras. Circuitos separados de água, óleo, ERS e hidráulica.'},
 {id:'fuel',spread:[0,.8,.3],number:'09',label:'Célula de combustível',short:'COMBUSTÍVEL',chapter:'15:39',color:'#e6c06d',description:'Célula flexível em Kevlar atrás do piloto e à frente do motor, com chicanas internas, pote coletor, bombas de elevação, medidor de vazão, acoplamento de abastecimento, válvula autosselante e linhas de combustível fora do cockpit.'},
 {id:'transmission',spread:[0,.4,-1.5],number:'10',label:'Câmbio e diferencial',short:'TRANSMISSÃO',chapter:'16:42',color:'#b7c2cc',description:'Carcaça estrutural com janela de corte, embreagem multidisco, oito pares de engrenagens em tomada constante mais ré com anéis de engate e tambor seletor, pinhão e coroa, diferencial e semieixos com juntas tripóide. As engrenagens giram nas relações de cada par.'},
 {id:'safety',spread:[0,1.5,.4],number:'11',label:'Segurança',short:'SEGURANÇA',chapter:'17:03',color:'#ff4d67',description:'Halo e encosto de cabeça exatamente como se veem por fora do carro, estrutura principal de capotamento no airbox, cone de impacto dentro do nariz, estrutura de impacto traseira com a luz de chuva, tubos anti-intrusão laterais, três cabos de retenção por roda, extintor e chaves externas.'},
 {id:'cockpit',spread:[0,1.0,1.2],number:'12',label:'Cockpit e retenção',short:'COCKPIT',chapter:'17:51',color:'#d9a8ff',hero:[.9,.9,-1],description:'Assento moldado dentro da cavidade do cockpit, arnês de seis pontos com fecho rotativo, HANS com tirantes, acelerador no pé direito, acolchoados de perna, hidratação, painel de chaves e rádio.'},
 {id:'wheel',spread:[0,1.3,1.5],number:'13',label:'Volante e comandos',short:'VOLANTE',chapter:'19:17',color:'#8db5ff',hero:[-.3,.3,-1],description:'Volante de 2026: corpo de carbono achatado com empunhaduras verticais, display de telemetria com quinze LEDs, botões coloridos com legendas (N, P, OT de override manual, AA de aerodinâmica ativa), balancins de freio, três seletores grandes, rolos de polegar, borboletas de marcha e de embreagem, engate rápido e cabo helicoidal. Clique em cada comando para ler o que ele faz.'},
 {id:'sensors',spread:[0,-1.0,-.7],number:'14',label:'Sensores',short:'SENSORES',chapter:'22:11',color:'#7ee5f2',description:'Tubo de Pitot, sensores de velocidade de roda com anéis dentados, câmeras infravermelhas de pneu, lasers de altura, ECU padrão, gravador de acidentes, unidade inercial, células de carga, termopares, transceptor e antena com chicote. As fitas mostram os dados indo do carro para o box.'}
]);
