...
export const SYSTEM_CATALOG=Object.freeze([
 ...
 {id:'transmission',spread:[0,.4,-1.5],number:'10',label:'Câmbio e diferencial',short:'TRANSMISSÃO',chapter:'16:42',color:'#b7c2cc',howItWorks:'A embreagem multidisco liga o motor à caixa de oito marchas, onde pares de engrenagens em tomada constante são engatados pelo tambor seletor em milissegundos. Pinhão e coroa viram o movimento em 90°, e o diferencial reparte o torque entre os semieixos para que as rodas girem em velocidades diferentes nas curvas.',observe:'Abra a carcaça e observe as engrenagens girando em cada relação. Siga o caminho embreagem → marchas → diferencial → juntas tripóide → rodas.',description:'Carcaça estrutural com janela de corte, embreagem multidisco, oito pares de engrenagens em tomada constante mais ré com anéis de engate e tambor seletor, pinhão e coroa, diferencial e semieixos com juntas tripóide. As engrenagens giram nas relações de cada par.'},
 {id:'safety',spread:[0,1.5,.4],number:'11',label:'Segurança',short:'SEGURANÇA',chapter:'17:03',color:'#ff4d67',howItWorks:'O halo e a estrutura de capotamento protegem a cabeça do piloto; o cone do nariz e a estrutura traseira absorvem energia em batidas; os tubos laterais resistem à intrusão. Três cabos por roda impedem que ela se solte, e o extintor e as chaves externas permitem o socorro rápido.',observe:'Localize o cone de impacto dentro do nariz e a luz de chuva na estrutura traseira. Na vista explodida, veja os três cabos de retenção de cada roda.',description:'Halo e encosto de cabeça exatamente como se veem por fora do carro, estrutura principal de capotamento no airbox, cone de impacto dentro do nariz, estrutura de impacto traseira com a luz de chuva, tubos anti-intrusão laterais, três cabos de retenção por roda, extintor e chaves externas.'},
...
export function createSystems({scene,model,mechanics,engine,driver,garage,camera,canvas,moveCamera,showCar=()=>{},onClose=showCar,mobile=false,assetUrl=SYSTEMS_ASSET}){
 ...
 let state='idle',loadPromise=null,gltfScene=null,flowsOn=true,coversOpen=false,schematic=false,ghostWanted=true,explodeAmount=0,revealSpread=0,revealEnabled=true,revealing=false,picked=null;
