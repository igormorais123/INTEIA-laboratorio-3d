...
A assinatura lateral passou a ser aplicada por `branding.js` em `e3d58af`. O snapshot graphify de `1ae4fd1` antecede essa ativação; use os grafos determinísticos para o estado desta entrega.
