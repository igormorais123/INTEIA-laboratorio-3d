...
**Como funciona / O que observar.** Ao isolar um sistema, o detalhe mostra dois blocos de leitura: o funcionamento do conjunto e o que procurar no modelo. Os textos ficam nos campos `howItWorks` e `observe` de cada item de `SYSTEM_CATALOG` e ficam ocultos na visão geral. A pesquisa que apoiou os textos está em [pesquisa-sistemas-2026-instrucao.md](pesquisa-sistemas-2026-instrucao.md).
