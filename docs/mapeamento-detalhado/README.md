...
> Licença atualizada em 21/09/2026: o código está sob [MIT](../../LICENSE), e os modelos têm [termos de preservação da marca INTEIA](../../ASSET-LICENSE.txt). Comece pelo [guia atual de download e reutilização](../../REUTILIZACAO.md). Os catálogos e grafos gerados abaixo são fotografias históricas: referências à licença proprietária nesses snapshots foram substituídas pela concessão atual para as contribuições originais.
