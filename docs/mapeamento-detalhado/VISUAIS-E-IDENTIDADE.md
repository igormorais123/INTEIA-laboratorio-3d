...
Essas orientações são caminhos técnicos. O repositório contém [licença proprietária INTEIA](../../LICENSE), e a licença da geometria e das imagens do tutorial não foi documentada/verificada. A visibilidade pública do repositório não concede por si só permissão de redistribuição dos assets.
